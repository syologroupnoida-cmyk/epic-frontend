...
import PartnerHeader from "@/common/PartnerHeader";
import PartnerFooter from "@/common/PartnerFooter";
...
const stats = [
  ...
  { value: 80, suffix: "+", label: "Service categories" },
  { value: 24, suffix: "h", label: "Lead response flow" },
];

const steps = [
  "Receive verified wedding inquiries",
  "Share services, packages, and availability",
...
const benefits = [
  ...
  "Visibility for venues, decor, catering, makeup, and photo teams",
...
const testimonials = [
  {
    name: "Ananya Sharma",
    role: "Venue Partner",
    quote: "The partner flow makes it easy to move from inquiry to package discussion without losing client context.",
    avatar: agentWorkflow,
  },
  {
    name: "Rohit Mehra",
    role: "Destination Partner",
...
const faqs = [
  {
    question: "Who can join as an Epic Wedz partner?",
    answer: "Wedding planners, venues, decorators, caterers, makeup artists, photographers, and sales partners can use the partner workflow.",
  },
  {
    question: "Can partners access login and sign up separately?",
    answer: "Yes. The partner header links directly to the existing partner login and sign up pages.",
  },
  {
    question: "What kind of leads can partners manage?",
    answer: "Partners can manage wedding inquiries for venues, decorators, caterers, makeup, photography, and destination planning.",
  },
  {
...
function TypedHeroTitle() {
  const title = "Grow your wedding business with confidence";
    ...
    <div className="min-h-screen bg-[#fff9f5] text-stone-900">
      ...
      <main>
          ...
          <div className="relative mx-auto flex min-h-[620px] max-w-7xl items-center px-4 py-20 text-white sm:px-6 lg:px-8">
            <div>
              <p className="text-sm font-bold uppercase tracking-[0.24em] text-[#ffd18a]">
                Epic Wedz Partner Network
              </p>
              <TypedHeroTitle />
              <p className="mt-5 max-w-xl text-base leading-8 text-white/82">
                A dedicated partner experience for turning wedding inquiries into
                qualified conversations, package discussions, and confirmed bookings.
              </p>
        ...
        <section id="workflow" className="scroll-mt-24 py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="mt-3 font-serif text-4xl font-bold text-stone-950">A cleaner flow for every partner inquiry</h2>
              <p className="mt-4 text-base leading-7 text-stone-600">
                Move each wedding lead through a simple model that keeps client
                needs, service fit, visits, and booking follow-ups easy to track.
              </p>
            </div>
        ...
        <section id="benefits" className="scroll-mt-24 bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              <p className="text-sm font-bold uppercase tracking-[0.22em] text-[#b61f4b]">Partner benefits</p>
              <h2 className="mt-3 font-serif text-4xl font-bold text-stone-950">Built for wedding service teams</h2>
            </div>
        ...
        <section id="clients" className="scroll-mt-24 bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="mt-3 font-serif text-4xl font-bold text-stone-950">Brands growing with the partner network</h2>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div>
              <div className="mx-auto max-w-3xl text-center">
                ...
                <h2 className="mt-3 font-serif text-4xl font-bold text-stone-950">Partners booking with more clarity</h2>
              </div>
              <div className="agent-slider mt-10 overflow-hidden">
        ...
        <section id="faq" className="scroll-mt-24 bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h2 className="mt-3 font-serif text-4xl font-bold text-stone-950">Partner questions answered</h2>
            </div>
        ...
        <section id="join" className="scroll-mt-24 px-4 py-14 sm:px-6 lg:px-8">
          <div className="mx-auto flex max-w-7xl flex-col gap-6 rounded bg-[#2a1119] px-6 py-12 text-white sm:px-8 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h2 className="mt-2 font-serif text-4xl font-bold">Create your partner account</h2>
            </div>
            <div className="flex flex-wrap gap-3">
              ...
              <Link href="/kyc" className="rounded-full border border-white px-7 py-3 text-sm font-bold text-white">Complete KYC</Link>
            </div>
          </div>
        </section>
      </main>
